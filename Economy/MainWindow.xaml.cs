...
namespace Economy
{
	public partial class MainWindow : Window
	{
		...
		{
			var window = new LoadWindow();
			window.Show();
			System.Windows.Threading.Dispatcher.Run();
		}

		public static async Task ProgressBarStartAsync(LoadWindowVerisonSecond loadWindow)
		{
			await Task.Run(() => { loadWindow.ShowDialog(); });
		}
